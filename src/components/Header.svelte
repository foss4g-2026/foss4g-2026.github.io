...
<div class="navbar bg-white shadow-md sticky top-0 z-50" style="font-family: 'Inter', sans-serif;">
  <div class="navbar-start flex-none w-auto">
    <div class="dropdown">
      ...
      <ul class="menu menu-sm dropdown-content bg-white rounded-lg z-[1000] mt-3 w-[90vw] p-2 shadow-xl border border-gray-100 max-h-[80vh] overflow-y-auto">
        <!-- Mobile Menu Items -->
        <li>
        ...
        <li>
          <details bind:open={mobileAttendingOpen}>
            ...
            <ul class="p-2">
              ...
              <li><NavLink href={'/' + data.locale + '/attending/qfield-app'} enabled={isNavEnabled('attending', 'qfieldApp')}>{$t('nav.attending_sub.qfield_app')}</NavLink></li>
            </ul>
          </details>
        </li>
        <li>
